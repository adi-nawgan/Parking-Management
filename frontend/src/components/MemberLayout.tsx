          ...
          `}>
            <div>
              <div className="flex items-center gap-2 mb-5">
                ...
                <span className="font-bold text-sm text-slate-200 flex-1">Member Portal</span>
                <button 
                  onClick={toggleMobile}
            ...
            <div className="flex items-center gap-3 p-3 rounded-lg bg-slate-900/60 border border-white/5">
              ...
              <div className="overflow-hidden">
                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Active Member</p>
                <p className="text-xs font-bold text-slate-300 truncate">{member?.name || 'Resident Member'}</p>
              </div>
            </div>
          </aside>
        </div>
