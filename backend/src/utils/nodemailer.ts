...
const sendEmail = async ({ to, subject, text, html }: SendEmailParams): Promise<boolean> => {
...
const sendFullAlertEmail = async (count: number, limit: number, adminEmail: string): Promise<boolean> => {
...
export { sendEmail, sendOverstayEmail, sendFullAlertEmail };
